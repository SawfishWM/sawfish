...
(let*
  ...
  (flet
	 ...
	 (setq shaped-frame `((,(funcall background)
			      (foreground . ,foreground)
			      (text . window-name)
			      (x-justify . 30)
			      (y-justify . center)
	 ...
	 (setq transient-frame `((,(funcall background)
				 (left-edge . 0)
				 (right-edge . 0)
				 (top-edge . -4)
				 (height . 4)
	 ...
	 (setq shaped-transient-frame `((,(funcall background)
					(left-edge . 0)
					(right-edge . 0)
					(top-edge . -5)
					(height . 4)
