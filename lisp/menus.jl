...
(defvar window-ops-menu
  `((,(_ "Move") move-window-interactively)
    (,(_ "Resize") resize-window-interactively)
    ...
    (,(_ "Send window to")
     ...
     ()
     (,(_ "Copy to previous workspace") copy-to-previous-workspace)
     (,(_ "Copy to next workspace") copy-to-next-workspace)
     ()
