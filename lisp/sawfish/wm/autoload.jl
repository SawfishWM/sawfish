...
(autoload-command (quote move-viewport-next) (quote "viewport-extras") #:class 'viewport)
(autoload-command (quote move-viewport-previous) (quote "viewport-extras") #:class 'viewport)
(autoload-command (quote move-window-previous) (quote "viewport-extras") #:class 'viewport)
(autoload-command (quote move-window-next) (quote "viewport-extras") #:class 'viewport)
;;; ::autoload-end::
