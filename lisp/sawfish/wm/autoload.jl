...
(autoload-command (quote workspace-right) (quote sawfish.wm.ext.workspace-grid))
(autoload-command (quote send-to-workspace-down) (quote sawfish.wm.ext.workspace-grid))
(autoload-command (quote send-to-workspace-up) (quote sawfish.wm.ext.workspace-grid))
(autoload-command (quote send-to-workspace-left) (quote sawfish.wm.ext.workspace-grid))
(autoload-command (quote send-to-workspace-right) (quote sawfish.wm.ext.workspace-grid))
;;; ::autoload-end::
