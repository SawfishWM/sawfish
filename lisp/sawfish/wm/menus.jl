...
(defvar window-ops-menu
  '(("Move" move-window-interactively)
    ...
    ("In group" . (lambda () (window-group-menu (input-focus))))
    ("Send window to"
     ("Previous workspace" send-to-previous-workspace)
     ("Next workspace" send-to-next-workspace)
     ()
